...
conf_set=0.40 
frame_size=(800, 480)
head_classification_threshold= 2.0 # make this value lower if want to detect non helmet more aggresively;
...
def img_classify(frame):
	...
	if frame.shape[0]<20: # skiping small size heads <----------------  you can adjust this value
		return [None, 0]
